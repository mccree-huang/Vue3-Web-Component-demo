<template>
  ...
  <hello-world-com :title="title" />
      ...
      <vaadin-number-field label="Min Age" v-model="filters.minAge"></vaadin-number-field>
      <vaadin-number-field label="Max Age" v-model="filters.maxAge"></vaadin-number-field>
...
const title = ref("I am a component-type Web Component, and my parent page is the Home Page.")
...
const filters = ref({
    ...
    const filteredItems = computed(() => {
      return items.value.filter(item => {
        ...
        const matchesMinAge = filters.value.minAge !== null ? item.age >= filters.value.minAge : true;
        const matchesMaxAge = filters.value.maxAge !== null ? item.age <= filters.value.maxAge : true;
